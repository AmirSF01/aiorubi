...
from aiorubi.types import BotCommand, Message
from aiorubi.utils.deep_linking import decode_payload
...
class Command(Filter):
    ...
    Works only with :class:`aiorubi.types.message.Message` events which have the :code:`text`.
    """
