...
from aiorubi.filters import Filter

if TYPE_CHECKING:
    from aiorubi.dispatcher.event.handler import CallbackType, FilterObject
...
def and_f(*targets: "CallbackType") -> _AndFilter:
    from aiorubi.dispatcher.event.handler import FilterObject
