...
Basic encode example:
    ...
    .. code-block:: python
        ...
        from aiorubi.utils.payload import encode_payload
...
Basic decode it back example:
    ...
    .. code-block:: python
        ...
        from aiorubi.utils.payload import decode_payload
...
Encoding and decoding with your own methods:
    ...
    2. Pass cryptor callable methods to aiorubi payload tools
